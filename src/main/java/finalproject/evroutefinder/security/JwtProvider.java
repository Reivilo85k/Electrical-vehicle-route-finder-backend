...
public class JwtProvider {
    ...
    public void init() {
        try {
            ...
            throw new EVRouteFinderException("Exception occurred while loading keystore", e);
        }
    ...
    private PrivateKey getPrivateKey() {
        try {
            ...
            throw new EVRouteFinderException("Exception occured while retrieving public key from keystore", e);
        }
    }
